...
|-----------|----------|----------|
| CI / Actions workflows, OIDC, GitHub App, self-service provisioning | Parker | ci.yml, provision-new-repo.yml, dependabot.yml, approval gates |
| Security scanners, SBOM, signing, provenance | Dallas | codeql.yml, secret-scan.yml, sbom-signing.yml, SLSA L3, required checks |
| Provisioning script (Python) | Brett | tools/provision_repo.py, PyGithub/gh, branch protection API, team grants |
| Governance & docs | Lambert | README, CONTRIBUTING, SECURITY, CODE_OF_CONDUCT, LICENSE, CODEOWNERS, issue/PR templates |
| Architecture, branch-protection design, code review | Ripley | Scope, trade-offs, security review, integration, reviewer gate |
